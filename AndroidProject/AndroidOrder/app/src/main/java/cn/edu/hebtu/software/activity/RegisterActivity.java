...
import cn.edu.hebtu.software.task.RegisterTask;
...
//        password.getBackground().setAlpha(128);
        ...
        repassword=findViewById(R.id.et_reg_sure_password);
//        repassword.getBackground().setAlpha(128);
        ...
        EditText etMessageCaptcha=findViewById(R.id.et_reg_message_captcha);
...
//        btnRegister.getBackground().setAlpha(153);
    ...
    private void init() {
        ...
        writer=findViewById(R.id.et_reg_message_captcha);
