...
import java.net.URL;
import cn.edu.hebtu.software.activity.WriteVerificationCodeActivity;
...
public class FindPhoneTask extends AsyncTask<String,Boolean,Boolean> {
    ...
    protected Boolean doInBackground(String[] strings) {
        ...
        try {
            ...
            String urlStr = serverUrl+"/user/findPhone?phone="+phone;
            url = new URL(urlStr);
    ...
    protected void onPostExecute(Boolean b) {
        if(b){//数据库中有该号码
            Intent intent = new Intent(context,WriteVerificationCodeActivity.class);
