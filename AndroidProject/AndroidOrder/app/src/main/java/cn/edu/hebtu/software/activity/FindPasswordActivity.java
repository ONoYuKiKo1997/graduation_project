...
import cn.edu.hebtu.software.task.FindPasswordTask;
...
public class FindPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_reset_password);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pwdStr.equals(surePwdStr)){//两次输入的密码一致
                    ...
                    FindPasswordTask updatePassword = new FindPasswordTask(getApplication());
