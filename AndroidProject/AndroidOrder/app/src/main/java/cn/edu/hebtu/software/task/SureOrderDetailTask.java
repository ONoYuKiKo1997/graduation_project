...
public class SureOrderDetailTask extends AsyncTask<String,Integer,Boolean>{
    private Context mContext;

    public SureOrderDetailTask(Context mContext){
    ...
    protected Boolean doInBackground(String... strings) {
        ...
        try {
            ...
            String urlStr = serverUrl+"/order/addOrderDetail?data="+ URLEncoder.encode(strings[0],"utf-8");
            Log.e("测试",urlStr);
            url = new URL(urlStr);
