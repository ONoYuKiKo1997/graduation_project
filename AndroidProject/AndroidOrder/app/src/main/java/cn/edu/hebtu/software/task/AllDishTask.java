...
public class AllDishTask extends AsyncTask<String, Void, List<Dish>> {
    private Context mContext;
    private ListView mListView;
    private Gson gson;

    public AllDishTask(Context mContext, ListView mListView){
