...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            vh.kouwei = view.findViewById(R.id.tv_goods_kouwei);
            vh.hunsu = view.findViewById(R.id.tv_goods_hunsu);
        ...
        if (dataList.size() > 0) {
            ...
            vh.hunsu.setText(map.get("hunsu"));
            vh.kouwei.setText(map.get("kouwei"));
            ShowDishImage s = new ShowDishImage(vh.icon,serverUrl+"/"+map.get("img"));
            s.execute();
    ...
    class ViewHolder {
        CheckBox checkBox;
        ImageView icon;
        TextView name, price, hunsu, kouwei, num, reduce, add;
    }
}
